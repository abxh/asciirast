...
using Mat2Int = Mat<2, 2, I, is_col_major>; ///< 2x2 int matrix
using Mat3Int = Mat<3, 3, I, is_col_major>; ///< 3x3 int matrix
using Mat4Int = Mat<4, 4, I, is_col_major>; ///< 4x4 int matrix
