...
Transform3D Transform3D::rotate(const Vec3f& forward_,
    ...
    const auto right = up_dir.cross(forward);
...
Transform3D Transform3D::rotateX(float angle_x) {
    const auto up_dir_y = cos(angle_x);
    const auto up_dir_z = sin(angle_x);
...
Transform3D Transform3D::rotateY(float angle_y) {
    ...
    const auto forward_x = cos(angle_y);
    const auto forward_z = sin(angle_y);
...
Transform3D Transform3D::rotateZ(float angle_z) {
    ...
    const auto up_dir_x = cos(angle_z);
    const auto up_dir_y = sin(angle_z);
